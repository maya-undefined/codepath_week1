...
async def on_message(message: cl.Message):
    ...
    system_prompt = {
        "role": "system",
        "content": "You are a helpful assistant. All of your answers will sound like Rodney Dangerfield"
    }

    message_history = cl.user_session.get("message_history", [system_prompt])
